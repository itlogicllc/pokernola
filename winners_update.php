				...
				<div data-role="collapsible-set">
					<div data-role="collapsible" data-collapsed="true">
						...
						<form action="<?php echo 'winners_update_action.php?game_id=' . $game_id . '&update_details=1' //echo $editFormAction;   ?>" method="POST" name="game_update" id="game_update<?php echo $random_num; ?>">
							...
							<div  class="ui-field-contain">
								<label for="registration<?php echo $random_num; ?>">Private Game:</label>
							...
							<div  class="ui-field-contain">
								...
								<input type="number" min="<?php echo count($game_players_array); ?>" max="<?php echo $settings_array[0]['max_players']; ?>" step="1" name="total_players" id="total_players<?php echo $random_num; ?>" value="<?php echo $game['num_players']; ?>"  />
							</div>
							<div  class="ui-field-contain">
					...
					<div data-role="collapsible" data-collapsed="true">
						...
						<ul data-role="listview" data-inset="true" data-count-theme="a" data-icon="delete">
							<?php for ($i = 0; $i <= count($game_players_array) - 1; $i++) { ?>
								<li>
									<a href="winners_delete_players_action.php?game_id=<?php echo $game_id; ?>&player_id=<?php echo $game_players_array[$i]['player_id']; ?>&game_players_id=<?php echo $game_players_array[$i]['game_players_id']; ?>"> 
