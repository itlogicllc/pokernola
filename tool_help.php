              ...
              <div data-role="collapsible" data-iconpos="right">
               ...
               <div data-role="collapsible" data-iconpos="right">
                  ...
                  <h3><img src="images/icons/check-white.png" alt="Game Registration" /> Game Registration</h3>
						<p>There are open games, signified by the <img alt="Open Game" src="images/open.png"> icon in the Game Schedule, and closed games, signified by the <img alt="Closed Game" src="images/private.png"> icon in the Game Schedule. Open games are those in which anyone can play. Closed games are those in which only PokerNOLA members can and must registered for. Guest players will only be allowed to play if the game has not reached its maximum allowed players at game time.</p>
						<p>The registration period ends at a given amount of hours before game time, or at game time. Check the season rules to find when the registration period ends. If the registration period has ended, no new registrants are allowed, but existing registrants may still unregister up to the game start time.</p>
