...
<div data-role="panel" id="login_panel" data-display="overlay" ui-panel-inner="true" data-position="right">
    <form ACTION="<?php echo $editFormAction; ?>" id="login" name="login" method="POST">
        ...
        <input name="email" type="email" id="email" value="<?php echo $_COOKIE['pokernola_player']; ?>" maxlength="30"  />
        <label for="password">Password:</label>
        <input name="password" type="password" id="password" value="<?php echo $_COOKIE['pokernola_pass']; ?>" maxlength="30"  />
