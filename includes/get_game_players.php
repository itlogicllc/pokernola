<?php
	...
	$game_players_query = "SELECT gp.game_players_id, gp.player_id, gp.game_id, gp.alternate_order, g.game_date, g.status, p.credits, CONCAT(p.first_name,' ',p.last_name) AS full_name
