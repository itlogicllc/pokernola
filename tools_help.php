   ...
   <body>
      <div data-role="page" id="pokernola_help">
         ...
         <div role="main" class="ui-content">
            <div class="ui-bar ui-bar-a ui-corner-all" align="center"><h2>Poker NOLA v1.1.0</h2></div><br />
            <div class="ui-corner-all custom-corners">
               ...
               <div class="ui-bar ui-bar-a">
                  <h2><img src="jquery-mobile/images/icons-png/calendar-white.png" /> Date Picker</h2>
               </div>
               <div class="ui-body ui-body-a">
                  ...
                  <p>Depending on where you are in the program, the calendar icon may change to a forbidden <img src="jquery-mobile/images/icons-png/forbidden-white.png" /> icon. The date picker is unavailable while the forbidden icon is shown.</p>
               </div>
               <div class="ui-bar ui-bar-a">
                  <h2><img src="jquery-mobile/images/icons-png/lock-white.png" /> / <img src="jquery-mobile/images/icons-png/edit-white.png" /> Log In / Profile</h2>
               </div>
               <div class="ui-body ui-body-a">
                  <p>A player, once registered, can log in and change their profile. When the icon at the bottom right is a lock <img src="jquery-mobile/images/icons-png/lock-white.png" /> it means the user is not logged in. Clicking or tapping on the lock opens the log in panel where they can enter their email address and password to log in. By clicking or tapping on the &quot;Remember Me&quot; checkbox, their credentials will remembered for next time they want to log in on that same device. Un-checking the box will cause that device to forget your credentials.</p>

                  <p>After a user has successfully logged in, the icon changes to an edit <img src="jquery-mobile/images/icons-png/edit-white.png" /> icon. Also, there will be a welcome message in the footer, above the time frame of data being viewed, using the logged in user's first name. Clicking or tapping on the edit icon will bring up that user's profile where they can update any of their information.</p>

                  <p>In the header of the player's profile is the <img src="jquery-mobile/images/icons-png/delete-white.png" /> icon. Clicking or tapping on this icon will log the user out of the system.</p>
               </div>
               <div class="ui-bar ui-bar-a">
                  <h2><img src="jquery-mobile/images/icons-png/home-white.png" /> Home</h2>
               </div>
               <div class="ui-body ui-body-a">
               ...
               <div class="ui-bar ui-bar-a">
                  <h2><img src="jquery-mobile/images/icons-png/user-white.png" /> Players</h2>
               </div>
               <div class="ui-body ui-body-a">
                  ...
                  <p>By clicking or tapping on the plus <img src="jquery-mobile/images/icons-png/plus-white.png" /> icon at the top left in the header, a new player can register with Poker NOLA.</p>

                  <p class="info">Note: Click or tap on a statistic label to get its definition.</p>
               </div>
               <div class="ui-bar ui-bar-a">
                  <h2><img src="jquery-mobile/images/icons-png/grid-white.png" /> Games</h2>
               </div>
               <div class="ui-body ui-body-a">
               ...
               <div class="ui-bar ui-bar-a">
                  <h2><img src="jquery-mobile/images/icons-png/gear-white.png" /> Tools</h2>
               </div>
               <div class="ui-body ui-body-a">
